            ...
            <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
                <div className='grid mb-8 lg:grid-cols-6'>
                    ...
                    <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <p className='mt-4 text-sm text-gray-500'>Lorem General texts are documents that are not linked to any object. They are stored in the system as independent system objects and are also transported as such.</p>
                    </div>
                </div>
